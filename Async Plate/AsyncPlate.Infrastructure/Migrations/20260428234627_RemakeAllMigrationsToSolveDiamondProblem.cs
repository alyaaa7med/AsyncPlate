...
{
    /// <inheritdoc />
    public partial class RemakeAllMigrationsToSolveDiamondProblem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chefs_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasedUnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalAmountPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    KitchenChefId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_Chefs_KitchenChefId",
                        column: x => x.KitchenChefId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTimesOrdered = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ExtraProductId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductExtra", x => new { x.ProductId, x.ExtraProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recipes", x => new { x.ProductId, x.InventoryId });
                    table.ForeignKey(
                        name: "FK_Recipes_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_KitchenChefId",
                table: "Orders",
                column: "KitchenChefId");
